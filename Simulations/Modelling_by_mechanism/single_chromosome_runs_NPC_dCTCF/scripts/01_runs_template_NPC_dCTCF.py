...
loopMatrix[11][39] = 0.8630*LAfactor*attrEnergyLoop # loop7
loopMatrix[11][22] = 0.1760*attrEnergyLoop # loop8
loopMatrix[11][25] = 0.3920*attrEnergyLoop # loop9
...
loopMatrix[13][25] = 0.1180*attrEnergyLoop # loop13
loopMatrix[15][24] = 0.0590*attrEnergyLoop # loop14
loopMatrix[15][25] = 0.0980*attrEnergyLoop # loop15
loopMatrix[16][22] = 0.2350*attrEnergyLoop # loop16
loopMatrix[16][25] = 0.4120*attrEnergyLoop # loop17
loopMatrix[17][21] = 0.5490*attrEnergyLoop # loop18
loopMatrix[17][25] = 0.1960*attrEnergyLoop # loop19
loopMatrix[18][26] = 0.4510*attrEnergyLoop # loop20
loopMatrix[19][26] = 0.3140*attrEnergyLoop # loop21
loopMatrix[20][26] = 0.7450*attrEnergyLoop # loop22
loopMatrix[22][27] = 1.0000*attrEnergyLoop # loop23
loopMatrix[23][34] = 0.6670*attrEnergyLoop # loop24
loopMatrix[23][31] = 0.5290*attrEnergyLoop # loop25
loopMatrix[23][40] = 0.5690*LAfactor*attrEnergyLoop # loop26
loopMatrix[23][43] = 0.2750*attrEnergyLoop # loop27
loopMatrix[23][46] = 0.2940*attrEnergyLoop # loop28
loopMatrix[28][35] = 0.9410*attrEnergyLoop # loop29
loopMatrix[28][36] = 0.7650*attrEnergyLoop # loop30
loopMatrix[28][37] = 0.8820*attrEnergyLoop # loop31
loopMatrix[28][40] = 0.9610*LAfactor*attrEnergyLoop # loop32
loopMatrix[28][42] = 0.8430*attrEnergyLoop # loop33
loopMatrix[28][46] = 0.8240*attrEnergyLoop # loop34
loopMatrix[29][31] = 0.9800*attrEnergyLoop # loop35
loopMatrix[29][38] = 0.4900*attrEnergyLoop # loop36
loopMatrix[29][47] = 0.3730*attrEnergyLoop # loop37
loopMatrix[32][40] = 0.6470*LAfactor*attrEnergyLoop # loop38
...
loopMatrix[35][40] = 0.3330*LAfactor*attrEnergyLoop # loop43
loopMatrix[35][42] = 0.1570*attrEnergyLoop # loop44
loopMatrix[35][45] = 0.0780*attrEnergyLoop # loop45
loopMatrix[41][45] = 0.6860*LAfactor*attrEnergyLoop # loop46
loopMatrix[41][47] = 0.6080*LAfactor*attrEnergyLoop # loop47
loopMatrix[41][42] = 0.4710*LAfactor*attrEnergyLoop # loop48
