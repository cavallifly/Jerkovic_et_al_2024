...
#Ea_0_00AA_0_00BB_0_00AB_La_3_00_Sl_1200_Ne_8_P_0_95_0_50_0_75_0_70_0_30_0_95_Ll_30_30_0_0_60_30_Rl_30_300_0_0_30_30
attrEnergiesEpi=0.00
attrEnergiesLoop=3.00
SMClifetimes=1200
NextrudersPerMbs=8
Permeabilities1=0.95
Permeabilities2=0.50
Permeabilities3=0.75
Permeabilities4=0.70
Permeabilities5=0.30
Permeabilities6=0.95
Llifetimes1=30
Llifetimes2=30
Llifetimes3=0
Llifetimes4=0
									...
									for Llifetime5 in ${Llifetimes5} ; do
										...
										for Permeability6 in ${Permeabilities6} ; do ##
											...
											for Rlifetime6 in ${Rlifetimes6} ; do
											    ...
											    wDir=Ea_${attrEnergyAA}AA_${attrEnergyBB}BB_${attrEnergyAB}AB_La_${attrEnergyLoop}_Sl_${SMClifetime}_Ne_${NextrudersPerMb}_eS_${extrusionSpeed}_P_${Permeability1}_${Permeability2}_${Permeability3}_${Permeability4}_${Permeability5}_${Permeability6}_Ll_${Llifetime1}_${Llifetime2}_${Llifetime3}_${Llifetime4}_${Llifetime5}_${Llifetime6}_Rl_${Rlifetime1}_${Rlifetime2}_${Rlifetime3}_${Rlifetime4}_${Rlifetime5}_${Rlifetime6}
											    ...
											    then
												awk '{print $0}' ${pythonScript} | sed -e "s/attrEnergyAA/${attrEnergyAA}/g" -e "s/attrEnergyBB/${attrEnergyBB}/g" -e "s/attrEnergyAB/${attrEnergyAB}/g" -e "s/attrEnergyLoop/${attrEnergyLoop}/g" -e "s/XXXloop_extruders_encounter_ruleXXX/${loop_extruders_encounter_rule}/g" -e "s/XXXloop_extruder_barrier_encounter_ruleXXX/${loop_extruder_barrier_encounter_rule}/g" -e "s/XXXSMClifetimeXXX/${SMClifetime}/g" -e "s/XXXNextrudersPerMbXXX/${NextrudersPerMb}/g" -e "s/XXXextrusionSpeedXXX/${extrusionSpeed}/g" -e "s/XXXloopingByXXX/${loopingBy}/g" -e "s/Permeability1/${Permeability1}/g" -e "s/Permeability2/${Permeability2}/g" -e "s/Permeability3/${Permeability3}/g" -e "s/Permeability4/${Permeability4}/g" -e "s/Permeability5/${Permeability5}/g" -e "s/Permeability6/${Permeability6}/g" -e "s/Llifetime1/${Llifetime1}/g" -e "s/Llifetime2/${Llifetime2}/g" -e "s/Llifetime3/${Llifetime3}/g" -e "s/Llifetime4/${Llifetime4}/g" -e "s/Llifetime5/${Llifetime5}/g" -e "s/Llifetime6/${Llifetime6}/g" -e "s/Rlifetime1/${Rlifetime1}/g" -e "s/Rlifetime2/${Rlifetime2}/g" -e "s/Rlifetime3/${Rlifetime3}/g" -e "s/Rlifetime4/${Rlifetime4}/g" -e "s/Rlifetime5/${Rlifetime5}/g" -e "s/Rlifetime6/${Rlifetime6}/g" > 01_runs_${condition}.py
											    fi
