...
#SMClifetimeInTauLJ          = 20 * 60 * secondInTauLJ
...
loopMatrix[11][25] = 0.3920*LPfactor*attrEnergyLoop # loop9
...
loopMatrix[13][25] = 0.1180*LPfactor*attrEnergyLoop # loop13
loopMatrix[15][24] = 0.0590*attrEnergyLoop # loop14
loopMatrix[15][25] = 0.0980*LPfactor*attrEnergyLoop # loop15
loopMatrix[16][22] = 0.2350*attrEnergyLoop # loop16
loopMatrix[16][25] = 0.4120*LPfactor*attrEnergyLoop # loop17
loopMatrix[17][21] = 0.5490*attrEnergyLoop # loop18
loopMatrix[17][25] = 0.1960*LPfactor*attrEnergyLoop # loop19
loopMatrix[18][26] = 0.4510*LPfactor*attrEnergyLoop # loop20
loopMatrix[19][26] = 0.3140*LPfactor*attrEnergyLoop # loop21
loopMatrix[20][26] = 0.7450*LPfactor*attrEnergyLoop # loop22
loopMatrix[22][27] = 1.0000*LPfactor*attrEnergyLoop # loop23
