...
#Best parameters
#Ea_0.02AA_0.02BB_0.02AB_La_3.00_LPf_0.25_Sl_4800_Ne_8_eS_1000_P_0.85_0.30_0.85_0.85_0.90_0.30_0.90_Ll_30_30_0_0_30_60_30_Rl_30_300_0_0_30_30_30
										...
										for Permeability6 in ${Permeabilities6} ; do 
											...
											for Rlifetime6 in ${Rlifetimes6} ; do
												...
												for Llifetime7 in ${Llifetimes7} ; do
													...
													wDir=Ea_${attrEnergyAA}AA_${attrEnergyBB}BB_${attrEnergyAB}AB_La_${attrEnergyLoop}_LPf_${LPfactor}_Sl_${SMClifetime}_Ne_${NextrudersPerMb}_eS_${extrusionSpeed}_P_${Permeability1}_${Permeability2}_${Permeability3}_${Permeability4}_${Permeability5}_${Permeability6}_${Permeability7}_Ll_${Llifetime1}_${Llifetime2}_${Llifetime3}_${Llifetime4}_${Llifetime5}_${Llifetime6}_${Llifetime7}_Rl_${Rlifetime1}_${Rlifetime2}_${Rlifetime3}_${Rlifetime4}_${Rlifetime5}_${Rlifetime6}_${Rlifetime7}
