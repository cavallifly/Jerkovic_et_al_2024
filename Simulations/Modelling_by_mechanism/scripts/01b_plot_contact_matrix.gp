...
set cblabel "Normalized contacts" 
set cblabel  offset character +1.5, 0, 0 font "Bold Arial, 28" textcolor lt -1 rotate by -270
set cbrange [ 0.1 : 100 ] noreverse nowriteback
set zero 1e-08
set lmargin  -1
set bmargin  -1
set rmargin  -1
...
set palette defined (0 "white", 0.25 "red", 1.0 "dark-red")
...
set xtics ("53.7" 0, "54.2" 300, "56.7" 599)
set ytics ("53.7" 0, "54.2" 300, "56.7" 599)
