...
set xlabel "Genomic position (Mb)" 
set xlabel  offset character 0, 0, 0 font "Bold Arial, 28" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ 53700000 : 56700000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
#set ylabel "Insulation Score (w=400kb)"
set ylabel "Normalized Insulation Score (IS)" 
...
set xtics ("53.7" 53700000, "54.7" 54700000, "55.7" 55700000, "1000000" 200, "56.7" 56700000)

set output "data_XXXtagXXX.ps"

p "data_XXXtagXXX.txt" u ($1):2 t "Models" w l lt 1 lw 5 lc rgb "blue" , \
  "exp_XXXtagXXX.txt"  u ($1):2 t "CHi-C" w l lt 1 lw 5 lc rgb "red"
