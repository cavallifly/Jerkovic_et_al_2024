...
extrusionSpeeds=1000                          # Ok, because paper from Bertrand group
loop_extruders_encounter_rule=crossing        # Ok, because paper from C. Dekker group
loop_extruder_barrier_encounter_rule=stalling # Ok, because lifetimeAtBarrier = 0 is relocating! 

#Best parameters
#Ea_0.00AA_0.00BB_0.00AB_La_4.00_LPf_0.75_Sl_4800_Ne_8_eS_1000_P_0.85_0.30_0.85_0.85_0.85_0.30_0.90_Ll_30_30_0_0_30_60_30_Rl_30_300_0_0_30_30_30
attrEnergiesEpi=0.00
LPfactors=0.75 
attrEnergiesLoop=4.00
SMClifetimes=4800    
NextrudersPerMbs=8   
Permeabilities1=0.85 
Permeabilities2=0.30 
Permeabilities3=0.85 
Permeabilities4=0.85 
...
for attrEnergyEpi in ${attrEnergiesEpi} ; do
	...
	for SMClifetime in ${SMClifetimes} ; do
		...
		extrusionSpeed=${extrusionSpeeds}
		for LPfactor in ${LPfactors}; do
										...
										for Permeability6 in ${Permeabilities6} ; do 
											...
											for Rlifetime6 in ${Rlifetimes6} ; do
												...
												for Llifetime7 in ${Llifetimes7} ; do
													...
													wDir=Ea_${attrEnergyAA}AA_${attrEnergyBB}BB_${attrEnergyAB}AB_La_${attrEnergyLoop}_LPf_${LPfactor}_Sl_${SMClifetime}_Ne_${NextrudersPerMb}_P_${Permeability1}_${Permeability2}_${Permeability3}_${Permeability4}_${Permeability5}_${Permeability6}_${Permeability7}_Ll_${Llifetime1}_${Llifetime2}_${Llifetime3}_${Llifetime4}_${Llifetime5}_${Llifetime6}_${Llifetime7}_Rl_${Rlifetime1}_${Rlifetime2}_${Rlifetime3}_${Rlifetime4}_${Rlifetime5}_${Rlifetime6}_${Rlifetime7}
